...
from cargan.utils.painter import draw_boxes, draw_fps
from cargan.utils.tfserving import DetectionClient, DetectionServer
from cargan.utils.webcam import WebcamVideoStream
...
def main():
    ...
    if tf_serving_server.is_running():
        ...
        # Start Demo
        # ###########
        viewer = WebCamViewer(video_capture, object_detector, score_threshold=0.3)
        viewer.run()
